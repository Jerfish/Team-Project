                ...
                <form id='newProblemForm' method='post' action='newProblem.php'>
                    <div id="requiredInfo" class="subTabContent">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="time" placeholder="06/11/2017 18:50" required oninvalid="alert('Please fill in the Call's Date/Time')"><br>
                            ...
                            <input type="text" class="form-control" name="hardwareID" id="hardwareID" placeholder="Kodak Printer"><br>
                            <label for="softwareId" id="softwareLabel">Software ID*</label>
                            <input type="text" class="form-control" name="softwareId" id="softwareId"placeholder="Photoshop"><br>
                    ...
                    <div id="additionalInfo" class="subTabContent">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="hardware" id="hardware" placeholder="C-40392-B"><br>
                            <label for="software" id="softwareIdLabel">Affected Software</label>
                            <input type="text" class="form-control" name="software" id="software"placeholder="S1039"><br>
